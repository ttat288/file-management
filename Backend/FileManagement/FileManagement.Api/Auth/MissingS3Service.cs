...
namespace FileManagement.Api.Auth
{
    public class MissingS3Service : IAWSS3Service
    {
        ...
        public Task<(string Url, string Key)> UploadFileAsync(UploadFileRequest file, string? bucketName = null, string? keyPrefix = null) => throw Missing();
        ...
        public Task<string> CreateFolderAsync(string folderKey, string? bucketName = null) => throw Missing();
